...
const squareGroupColorMap = new Map([
...
const SquareConfigData = new Map();
...
SquareConfigData.set(3, { type: SquareType.Airport, section: BoardSection.Bottom });
SquareConfigData.set(4, { type: SquareType.Property, section: BoardSection.Bottom, groupId: 1 });
SquareConfigData.set(5, { type: SquareType.Property, section: BoardSection.Bottom, groupId: 1 });
...
SquareConfigData.set(8, { type: SquareType.Airport, section: BoardSection.Bottom });
...
SquareConfigData.set(13, { type: SquareType.Airport, section: BoardSection.Left });
...
SquareConfigData.set(23, { type: SquareType.Airport, section: BoardSection.Top });
...
SquareConfigData.set(28, { type: SquareType.Airport, section: BoardSection.Top });
...
SquareConfigData.set(33, { type: SquareType.Airport, section: BoardSection.Right });
...
SquareConfigData.set(37, { type: SquareType.Property, section: BoardSection.Right, groupId: 8 });

SquareConfigData.set(38, { type: SquareType.Property, section: BoardSection.Right, groupId: 8 });
SquareConfigData.set(39, { type: SquareType.Airport, section: BoardSection.Right });
